...
(
 ...
 ("List-Id"
  ("<DW-SSG.yahoogroups.com>" . "lists/DW-SSG")
  ("<diaspora" . "lists/diaspora")
  ("<SGoM.yahoogroups.com>" . "lists/SGoM")
  ("SGoM.yahoogroups.com" . "lists/SGoM")
  ("<info-fsf.gnu.org>" . "lists/info-fsf")
  ("<mailman.tkb.mpl.com>" . "lists/tkb.mpl.com")
  ("<mailman.freebsd.org>" . "lists/freebsd.org")
  ("<mailman.python.org>" . "lists/python.org")
  ("mailman.yquem.inria.fr" . "lists/inria")
  ...
  ("<cminusminus.eecs.harvard.edu>" . "lists/cminusminus")
  ...
  ("<mailman.lists.adacore.com>" . "lists/adacore")
 ...
 ("From"
  ("news@news.beefmagazine.com" . "lists/beef-daily")
  ("cafh@comcast.net" . "users/harrison_chuck")
 ...
 ("To"
  ("wl-en@ml.gentei.org" . "lists/wanderlust-english")
  ("kwitt@wvhtf.org" . "users/witt_ken")
  ("ttatha@citynet.net" . "users/atha_tristan")
  ("pdf_and_llf@yahoo.com" . "users/fritsch_peter")
  ("1PG@yahoogroups.com" . "lists/1PG")
  ("3048719600@messaging.sprintpcs.com" . "users/bond_deborah")
  ...
  ("James W. Atha II" . "users/atha_james")
  ("K12-MARION-CLOSINGS@LISTSERV.WVNET.EDU" . "lists/k12-marion-closings")
  ...
  ("embond@citynet.net" . "users/bond_esther")
  ("estherbond@hughes.net" . "users/bond_esther")
  ("estherbond@lhfwv.com" . "usesrs/bond_esther")
